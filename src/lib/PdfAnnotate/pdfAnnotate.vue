<template>
  <div class="main">
    <div class="toolbar" v-if="toolbar">
      ...
      <button class="cursor mr-10" type="button" title="Cursor" data-tooltype="cursor">➚</button>
      <button class="eraser mr-20" type="button" title="Eraser" data-tooltype="eraser">⌫</button>
      <button class="rectangle" style="display: none" type="button" title="Rectangle" data-tooltype="area">&nbsp;</button>
      <button class="circle" style="display: none" type="button" title="Circle" data-tooltype="circle">○</button>
      <button style="display: none" class="circle" type="button" title="fillCircle" data-tooltype="fillcircle">◉</button>
      <button style="display: none" class="circle" type="button" title="emptyCircle" data-tooltype="emptycircle">⦿</button>
      <button style="display: none" class="arrow" type="arrow" title="Arrow" data-tooltype="arrow">➤</button>
      <div style="display: none" class="hotspot-color"></div>
      <button style="display: none" class="highlight" type="button" title="Highlight" data-tooltype="highlight">&nbsp;</button>
      <button style="display: none" class="strikeout" type="button" title="Strikeout" data-tooltype="strikeout">&nbsp;</button>
      <div style="display: none" class="spacer"></div>
      <button class="text mr-5" type="button" title="Text Tool" data-tooltype="text"></button>
      <select style="display: none" class="text-size"></select>
      <div class="text-color mr-10"></div>
      <div style="display: none" class="spacer"></div>
      <button class="pen mr-5" type="button" title="Pen Tool" data-tooltype="draw">✎</button>
      <select style="display: none" class="pen-size"></select>
      <div class="pen-color mr-10"></div>
      <div style="display: none" class="spacer"></div>
      <!-- <button class="comment mr-10" type="button" title="Comment" data-tooltype="point"><img src="image/comment.png" alt="comment"></button> -->
      <button class="comment mr-10" type="button" title="Comment" data-tooltype="point">🗨</button>
      <div style="display: none" class="spacer"></div>
      <select style="display: none" class="scale mr-10">
        <option value=".5">50%</option>
        <option value="1">100%</option>
        <option value="1.5">150%</option>
        <option value="2">200%</option>
      </select>
      <a style="display: none" href="javascript://" class="rotate-ccw mr-10" title="Rotate Counter Clockwise">⟲</a>
      <a style="display: none" href="javascript://" class="rotate-cw mr-10" title="Rotate Clockwise">⟳</a>
      <div style="display: none" class="spacer"></div>
      <a href="javascript://" class="clear" title="Clear Annotations">×</a>
      </div>
      <span @click="downloadPdf" class="download">Download<img src="images/save.png" alt="save"></span>
    </div>
...
import { PDFLinkService, PDFPageView, PDFFindController,
...
export default {
  ...
  methods: {
    downloadPdf () {
      pdfjsLib
        .getDocument(this.RENDER_OPTIONS.documentId)
        .then((pdf) => {
          pdf.getData().then((u8) => {
